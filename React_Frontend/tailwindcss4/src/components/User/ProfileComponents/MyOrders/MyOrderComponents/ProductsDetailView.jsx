...
const ProductsDetailView = ({ currentView,setCurrentView }) => {
  ...
  <div className="flex flex-col md:flex-row md:items-center gap-6">
    ...
    <div className="flex-1">
      <p className="mb-2">
        ...
        <span className="font-bold text-lg text-gray-900">{product.product_item.product.shop.shop_name}</span>
      </p>
      <p className="mb-2">
    ...
    <div className="flex-shrink-0">
      <button
        ...
        onClick={()=>{setCurrentView({ view1:"sellerfeedback",sid:product.product_item.product.shop.id});}}
