        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="p-6 bg-white shadow-md rounded-lg mb-6">
                <div className="flex flex-row gap-4 items-center">
                    <input type="text" placeholder="Search Orders" className="flex-grow p-2 border rounded-md shadow-sm" />
                    <div className="w-full flex flex-col md:flex-row items-center gap-4">
                        ...
                        >
                            ...
                            <option value="cancelled" className="bg-green-600 text-white">
                                Delivered Orders
                            </option>
                            <option value="delivered" className="bg-red-500 text-white">
                                Cancelled Orders
                            </option>
                        </select>
            ...
            {currentView === "neworders" && (
                <div className="p-6 bg-white shadow-md rounded-lg">
                    <table className="w-full text-left table-auto border-collapse">
                        ...
                        <tbody>
                            {orders.filter((item)=>item.order.order_status.status===orderstatus).map((item, index) => (
