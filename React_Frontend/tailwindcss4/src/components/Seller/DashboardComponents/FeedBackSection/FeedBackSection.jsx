...
const FeedBackSection = () => {
    ...
    const handleRating = (star) => {
      ...
      const handleSubmit = async () => {
        ...
        try {
            const response = await axios.post(`https://127.0.0.1:8000/api/seller/add_seller_feedback/`,
              formData,
              {
                headers: {
  ...
  return (
    ...
    <div className="py-6 px-6">
        <div className="flex gap-4">
          <button onClick={()=>setCurrentView("feedback")} className="px-4 py-2 bg-indigo-500 text-white font-medium rounded-lg hover:bg-indigo-600">
            User Feedbacks
          </button>
          <button onClick={()=>setCurrentView("send")} className="px-4 py-2 bg-green-500 text-white font-medium rounded-lg hover:bg-green-600">
